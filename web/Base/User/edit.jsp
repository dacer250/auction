...
<div class="container">
    ...
    <div class="login_panel">
        <div>
            <form id="id_form1" action="save" method="post">
                ...
                <div class="form-group">
                    <label>手机号</label>
                    <input id="user_phone" value="${obj.user_phone}" class="form-control" disabled="disabled">
                    <input name="o['user_phone']" value="${obj.user_phone}" type="hidden">
                </div>
                <div class="form-group">
                    <label>游戏ID</label>
                    <input value="${obj.game_id}" class="form-control" disabled="disabled">
                </div>
                ...
                <%--<div class="form-group">
                    <label>真实姓名</label>
                    <input name="o['user_name']" value="${obj.user_name}" class="form-control validate[maxSize[20]]">
                </div>--%>
                <div class="form-group">
                    <label>微信号</label>
                    <input name="o['wx_no']" value="${obj.wx_no}" class="form-control">
                </div>
                <%--<div class="form-group">--%>
                    <%--<label>QQ号</label>--%>
                    <%--<input name="o['qq_id']" value="${obj.qq_id}" class="form-control">--%>
                <%--</div>--%>
                <div class="form-group">
                    <label>短信验证码</label>
                    <div>
