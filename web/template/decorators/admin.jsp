                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li>
                                <a href="/a/admin/Class/list"><i class="fa fa-home"></i> 分类管理
                            ...
                            <li>
                                <a href="/a/admin/Goods/list"><i class="fa fa-home"></i> 展品管理
                                    <!--<span class="fa fa-chevron-down"></span>--></a>
                            </li>
                            <li>
                                <a href="/a/admin/Information/list"><i class="fa fa-home"></i> 资讯管理
                                    <!--<span class="fa fa-chevron-down"></span>--></a>
                            </li>
                        </ul>
                    </div>
